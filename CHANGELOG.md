...
The salient features of v0.6.0 are (i) the release of the primal decomposition (PriDec) solver for structured two-stage problems and (ii) improved support for (NVIDIA) GPUs for solving sparse optimization problems via NVIDIA's cuSOLVER API and newly developed condensed optimization kernels.
