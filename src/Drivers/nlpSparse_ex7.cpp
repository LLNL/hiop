...
bool Ex7::get_prob_sizes(int_type& n, int_type& m)
{
  n=n_vars;
  m=n_cons;
  return true;
...
bool Ex7::get_vars_info(const int_type& n, double *xlow, double* xupp, NonlinearityType* type)
{
  assert(n==n_vars);
...
bool Ex7::get_cons_info(const int_type& m, double* clow, double* cupp, NonlinearityType* type)
{
  assert(m==n_cons);
  int_type conidx{0};
...
bool Ex7::eval_f(const int_type& n, const double* x, bool new_x, double& obj_value)
{
  assert(n==n_vars);
  obj_value=0.;
...
bool Ex7::eval_grad_f(const int_type& n, const double* x, bool new_x, double* gradf)
{
  assert(n==n_vars);
...
bool Ex7::eval_cons(const int_type& n,
                    const int_type& m,
...
bool Ex7::eval_cons(const int_type& n, const int_type& m,
...
bool Ex7::eval_Jac_cons(const int_type& n,
                        const int_type& m,
                        const int_type& num_cons,
                        const int_type* idx_cons,
                        const double* x,
...
bool Ex7::eval_Hess_Lagr(const int_type& n,
                         const int_type& m,
                         const double* x,
                         bool new_x,
...
bool Ex7::get_starting_point(const int_type& n, double* x0)
{
  assert(n==n_vars);
  for(auto i=0; i<n; i++)
    x0[i]=0.0;
