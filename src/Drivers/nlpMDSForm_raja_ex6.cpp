#include "nlpMDSForm_raja_ex6.hpp"
...
EX6::EX6(int ns_in, int nd_in, std::string mem_space)
...
void EX6::initialize()
{
  ...
  RAJA::forall<EX6_raja_exec>(RAJA::RangeSegment(1, nd_-1),
...
bool EX6::get_vars_info(const long long& n, double *xlow, double* xupp, NonlinearityType* type)
{
  ...
  //x
  RAJA::forall<EX6_raja_exec>(RAJA::RangeSegment(0, ns_),
    RAJA_LAMBDA(RAJA::Index_type i)
    {
      xlow[i] = -1e+20;
    });
  ...
  //s
  RAJA::forall<EX6_raja_exec>(RAJA::RangeSegment(ns_, 2*ns_),
    RAJA_LAMBDA(RAJA::Index_type i)
    {
      xlow[i] = 0.;
    });
  ...
  RAJA::forall<EX6_raja_exec>(RAJA::RangeSegment(2*ns_, n),
    RAJA_LAMBDA(RAJA::Index_type i)
    {
...
bool EX6::get_sparse_dense_blocks_info(int& nx_sparse, int& nx_dense,
...
bool EX6::eval_f(const long long& n, const double* x, bool new_x, double& obj_value)
{
...

  {
    ...
    RAJA::ReduceSum<EX6_raja_reduce, double> aux(0);
    RAJA::forall<EX6_raja_exec>(RAJA::RangeSegment(0, nd_),
      RAJA_LAMBDA(RAJA::Index_type i)
      {
    ...
    const double* x, bool new_x, double* cons)
{
  ...
  {
    RAJA::forall<EX6_raja_exec>(RAJA::RangeSegment(0, num_cons),
    ...
    double* JacD)
{
  ...
  if(iJacS!=NULL && jJacS!=NULL)
  {
    ...
    if(num_cons==3 && haveIneq_ && ns_>0) 
    {
      ...
      RAJA::forall<EX6_raja_exec>(RAJA::RangeSegment(0, ns_+2),
    ...
    int& nnzHSD, int* iHSD, int* jHSD, double* MHSD)
{
  ...
  {
    RAJA::forall<EX6_raja_exec>(RAJA::RangeSegment(0, 2*ns_),
      RAJA_LAMBDA(RAJA::Index_type i)
      {
        iHSS[i] = jHSS[i] = i;
      });
  ...
  if(HDD!=NULL)
  {
    ...
    RAJA::forall<EX6_raja_exec>(RAJA::RangeSegment(0, nx_dense_squared),
      RAJA_LAMBDA(RAJA::Index_type i)
      {
...
bool EX6::get_starting_point(const long long& global_n, double* x0)
{
  assert(global_n==2*ns_+nd_); 
  RAJA::forall<EX6_raja_exec>(RAJA::RangeSegment(0, global_n),
    RAJA_LAMBDA(RAJA::Index_type i)
    {
      x0[i] = 1.;
    });
...
bool EX6::get_starting_point(const long long& n, const long long& m,
    double* x0,
    bool& duals_avail,
 ...
 */
void EX6::set_solution_primal(const double* x_vec)
{
  int n=2*ns_+nd_;
...
void EX6::set_solution_duals(const double* zl_vec, const double* zu_vec, const double* lambda_vec)
{
...
bool EX6OneCallCons::eval_cons(const long long& n, const long long& m, 
    const double* x, bool new_x, double* cons)
{
  ...
  RAJA::forall<EX6_raja_exec>(RAJA::RangeSegment(0, m),
 ...
 * 
 */
bool EX6OneCallCons::eval_Jac_cons(const long long& n, const long long& m, 
    const double* x, bool new_x,
    const long long& nsparse, const long long& ndense, 
    const int& nnzJacS, int* iJacS, int* jJacS, double* MJacS, 
    double* JacD)
{
  ...
  if(JacD!=NULL)
  {
    ...
    if(haveIneq_)
    {
      ...
      RAJA::forall<EX6_raja_exec>(RAJA::RangeSegment(0, 3*nd_),
        RAJA_LAMBDA(RAJA::Index_type i)
        {
          J[i] = 1.0;
        });
