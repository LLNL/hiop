#ifndef HIOP_EXAMPLE_RAJA_EX6
#define HIOP_EXAMPLE_RAJA_EX6
...
class EX6 : public hiop::hiopInterfaceMDS
{
public:
  EX6(int ns_in, std::string mem_space)
    : EX6(ns_in, ns_in, mem_space)
  {
  }
  
  EX6(int ns_in, int nd_in, std::string mem_space);
...
class EX6OneCallCons : public EX6
{
  public:
    EX6OneCallCons(int ns_in, std::string mem_space)
      : EX6(ns_in, mem_space)
    {
    }

    EX6OneCallCons(int ns_in, int nd_in, std::string mem_space)
      : EX6(ns_in, nd_in, mem_space)
    {
    }

    virtual ~EX6OneCallCons()
    {
    }
