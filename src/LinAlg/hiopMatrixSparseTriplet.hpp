...
public:
  ...
  virtual void copyRowsFrom(const hiopMatrix& src, const int_type* rows_idxs, int_type n_rows);
  ...
  */
  virtual void copySubDiagonalFrom(const int_type& start_on_dest_diag,
  ...
  */
  virtual void setSubDiagonalTo(const int_type& start_on_dest_diag,
                                const int_type& num_elems,
                                const double& c,
                                const int_type& start_on_nnz_idx);
  ...
  virtual void copyRowsBlockFrom(const hiopMatrix& src_gen,
                                 const int_type& rows_src_idx_st,
                                 const int_type& n_rows,
                                 const int_type& rows_dest_idx_st,
  ...
  */
  ...
  virtual int_type numberOfOffDiagNonzeros() const {assert("not implemented"&&0);return 0;};
...
public:
  ...
  virtual int_type numberOfOffDiagNonzeros() const;
