...
public:
  ...
  Tidx n() const { return nrows; }
  Tidx m() const { return ncols; }
  Tidx numberOfNonzeros() const { return nnz; }
  Tidx* i_row() const { return irow; }
  Tidx* j_col() const { return jcol; }
  Tval* M() const { return values; }
protected:
