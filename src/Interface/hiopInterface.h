...
extern int hiop_sparse_createProblem(cHiopSparseProblem *problem);
extern int hiop_sparse_solveProblem(cHiopSparseProblem *problem);
extern int hiop_sparse_destroyProblem(cHiopSparseProblem *problem);